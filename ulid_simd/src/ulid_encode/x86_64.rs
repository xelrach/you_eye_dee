...
use std::arch::x86_64::{
    ...
    _mm_setr_epi8, _mm_shuffle_epi8, _mm_srli_si128, _mm_storeu_si128,
};
...
pub fn u128_to_ascii_ssse3(ulid: &u128) -> String {
    unsafe {
...
pub fn u128_to_ascii_avx2(ulid: &u128) -> String {
    unsafe {
        let byte_array = ulid.to_ne_bytes();
        let le_bytes = byte_array.as_ptr();
